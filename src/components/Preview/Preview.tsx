...
const Preview = () => {
  return (
    <main className="w-screen h-[28vh] bg-neutral-800 relative">
        ...
        <a href="#popular" className="absolute z-10 bottom-[20px] left-[20px] bg-lime-400 selection:bg-transparent hover:bg-lime-500 transition-[200ms] text-stone-800 shadow-sm font-[400] p-2 tracking-wider px-4 rounded-full">buy now!</a>
    </main>
  )
}
