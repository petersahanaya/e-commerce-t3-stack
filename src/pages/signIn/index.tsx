...
const SignIn = () => {
  return (
    ...
    <main className="p-3 w-screen h-screen inline-block 3xl:w-[50vw] 4xl:w-[50vw] 2lg:top-[400px] 4xl:top-[350px] lg:w-[70vw] md:w-[80vw] xl:w-[50vw] xl:flex xl:justify-around xl:items-center xl:top-[60px] 3xl:top-[200px] absolute top-[40px] left-0 z-40">
      <nav className="xl:w-[40vw]">
        <h3 className="text-stone-100 4xl:w-[70vw] 2lg:w-[90vw] text-start xl:text-5xl 4xl:text-9xl md:text-5xl 3xl:text-[10rem] 3xl:leading-[10rem] xl: font-[900] selection:bg-orange-100 
